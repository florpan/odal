...
import { stepShots } from './projectiles';
...
//   4. projectiles (shots in flight advance; the ones that arrive deal damage)
//   5. research    (each player's community-wide research queue)
//   6. upkeep      (units eat, every rules.upkeepInterval seconds)
...
export { separateUnits, stepResearch, stepShots, stepUpkeep };
