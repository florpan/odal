...
export class GameSession {
  ...
  private frame(dt: number, now: number) {
    ...
    if (st) {
      r.setSelection(this.world.selectedUnits, this.world.selectedBuilding, this.world.renderBuildings());
  ...
  action(id: string) {
    ...
    switch (kind) {
      ...
      case 'train':
        ...
        break;
      case 'research':
        if (bId !== null) this.net.send({ type: 'research', buildingId: bId, tech: arg });
        break;
      case 'cancelQueue':
